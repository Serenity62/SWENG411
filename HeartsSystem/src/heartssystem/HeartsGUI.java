...
public class HeartsGUI extends BasicGUI {
    private static HeartsGUI instance = null;
    ...
    public static HeartsGUI getInstance() {
        if (instance == null) {
            instance = new HeartsGUI();
        }
        return instance;
    }
    ...
    private HeartsGUI() {
        ...
        EnterNamesGUI enterNames = EnterNamesGUI.getInstance(getEngine(), this);
    ...
    public void updateNames() {
        int id = getEngine().getPlayerID();
        for (int i = 0; i <= 3; i++) {
            playerLabels[i].setText(getEngine().getPlayer(id).getName());
            id++;
            if (id == 4) {
                id = 0;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HeartsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HeartsGUI h = HeartsGUI.getInstance();
                h.setTitle("Hearts");
                h.setVisible(true);
